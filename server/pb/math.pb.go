...
var file_math_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x22, 0x35, 0x0a, 0x0b, 0x4d, 0x61, 0x74, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	,
...
var file_math_proto_depIdxs = []int32{
	...
	0, // 1: math.MathService.Subtract:input_type -> math.MathRequest
	0, // 2: math.MathService.Multiply:input_type -> math.MathRequest
	0, // 3: math.MathService.Divide:input_type -> math.MathRequest
	1, // 4: math.MathService.Add:output_type -> math.MathResponse
	1, // 5: math.MathService.Subtract:output_type -> math.MathResponse
	1, // 6: math.MathService.Multiply:output_type -> math.MathResponse
	1, // 7: math.MathService.Divide:output_type -> math.MathResponse
...
func (c *mathServiceClient) Subtract(ctx context.Context, in *MathRequest, opts ...grpc.CallOption) (*MathResponse, error) {
	out := new(MathResponse)
	err := c.cc.Invoke(ctx, "/math.MathService/Subtract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mathServiceClient) Divide(ctx context.Context, in *MathRequest, opts ...grpc.CallOption) (*MathResponse, error) {
	out := new(MathResponse)
	err := c.cc.Invoke(ctx, "/math.MathService/Divide", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MathService_Subtract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/math.MathService/Subtract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MathService_Divide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/math.MathService/Divide",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
